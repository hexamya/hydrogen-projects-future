...
# Regional Analysis: Count technology adoption by country
regional_technology = technology_data.groupby(['Country', technology_column]).size().reset_index(name='Count')
...
plt.figure(figsize=(14, 7))
sns.barplot(x='Count', y='Country', hue=technology_column, data=regional_technology, dodge=True)
