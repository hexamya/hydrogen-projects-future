...
numerical_cols = [
    ...
    'Capacity_MWel', 'Capacity_Nm³ H₂/h', 'Capacity_kt H2/y',
                  ...
                  'zero-carbon estimated normalized capacity [Nm³ H₂/hour]', 'LOWE_CF']
...
features = [
    # 'Announced Size',
    'Capacity_MWel', 'Capacity_Nm³ H₂/h', 'Capacity_kt H2/y',
            'Capacity_t CO₂ captured/y', 'zero-carbon estimated normalized capacity [Nm³ H₂/hour]', 'LOWE_CF']
...
optimal_clusters = 3  # Adjust based on silhouette score plot
...
# Choose the best clustering method b
bestlabels = kmeans_labels if kmeans_score >= agg_score and kmeans_score >= dbscan_score else (agg_labels if agg_score >= dbscan_score else dbscan_labels)
bestmethod = 'K-Means' if kmeans_score >= agg_score and kmeans_score >= dbscan_score else ("Agglomerative" if agg_score >= dbscan_score else "DBSCAN")
